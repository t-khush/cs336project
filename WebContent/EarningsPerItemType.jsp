...
<title>BuyMe: Earnings Per Item Type</title>
</head>
<style>
...
<center><body>
	<%
		try {
			...
			out.println("<h1 style='font-size:30px'><strong>Earnings per Item Type</strong></h1>");
			out.println("<br><br>");
			if (!result.next()) {
				out.println("<h2 style='font-size:25px'><strong>No items have been bought!</strong></h1>");
			}
			else {
				out.println("<br>");
				// ITEM DETAILS
				out.println("<table>");
				out.println("<tr>");
		        out.println("<td><strong> Item Type </strong></td><td><strong> Earnings </strong></td>");
		        out.println("</tr>");
	       		int i = 1;
	       		result.beforeFirst();
	   	        while(result.next()) {
