...
<title>BuyMe: Earnings Per Item</title>
</head>
<style>
...
<center><body>
	<%
		try {
			...
			out.println("<h1 style='font-size:30px'><strong>Earnings per Item</strong></h1>");
			out.println("<br><br>");
			if (!result.next()) {
				...
				out.println("<table>");
				out.println("<tr>");
		        out.println("<td><strong> Item </strong></td><td><strong> Earnings </strong></td>");
		        out.println("</tr>");
	       		int i = 1;
	       		result.beforeFirst();
	   	        while(result.next()) {
